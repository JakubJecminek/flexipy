...
def create_bank_item(kod, dat_vyst, typ_dokl=config.typ_bank_dokladu[0], typ_pohybu=config.typ_pohybu[0], 
...
def delete_bank_item(id):
	__delete_item(id, 'banka')

def update_bank_item(id, bank_item):
