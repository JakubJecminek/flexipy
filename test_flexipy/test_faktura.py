...
def test_get_all_vydane_faktury():
	...
	list_of_invoices_actual = faktura.get_all_vydane_faktury()
...
def test_get_all_prijate_faktury():
	...
	list_of_invoices_actual = faktura.get_all_prijate_faktury()
	assert list_of_invoices_expected == list_of_invoices_actual
...
def test_create_vydana_faktura():
	...
	result = faktura.create_vydana_faktura(kod='flex11', var_sym='11235484', datum_vyst='2013-02-28', zdroj_pro_sklad=False, typ_dokl=config.get_typy_faktury_vydane()[0], dalsi_param=dalsi_param)
	assert result[0] == True #expected True
	id = result[1]
	actualData = faktura.get_vydana_faktura(id, detail='full') 
...
def test_create_vydana_faktura_polozky():
	...
	result = faktura.create_vydana_faktura(kod='flex12', var_sym='11235484', datum_vyst='2013-02-28', 
