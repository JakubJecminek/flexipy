...
Structure of flexipy library is trying to follow best practices at python development described at The Hitchhiker’s Guide to Python!\cite{pythonGuide} which is written by importent python comunity figure Kenneth Reitz who is also author of Requests library that is used in flexipy for handling HTTP requests and reponses. The folder structure of flexipy library: 
